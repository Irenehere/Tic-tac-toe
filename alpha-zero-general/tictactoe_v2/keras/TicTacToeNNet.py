...
class TicTacToeNNet():
    def __init__(self, game, args):
        ...
        self.energies = Input(shape=(2,))    # s: batch_size x 2
        ...
        # concate energies
        s_fc1_c = concatenate([s_fc1, self.energies], axis=1)

        s_fc2 = Dropout(args.dropout)(Activation('relu')(BatchNormalization(axis=1)(Dense(512)(s_fc1_c))))          # batch_size x 1024

        self.pi = Dense(self.action_size, activation='softmax', name='pi')(s_fc2)   # batch_size x self.action_size
        self.v = Dense(1, activation='tanh', name='v')(s_fc2)                    # batch_size x 1

        self.model = Model(inputs=[self.input_boards, self.energies], outputs=[self.pi, self.v])
